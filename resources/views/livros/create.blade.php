...
<body>
    ...
    <form style="width: 300px" method="POST" action="{{ route('livros.store', $alunos->id) }}" >
        @csrf
        <div class="mb-1">
        ...
        <div class="mb-3">
          ...
          <input type="number" maxlength="4" name="ano" class="form-control" id="exampleInputPassword1">
        </div>
